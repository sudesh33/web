...
?>
    ...
    <section class="home-slider owl-carousel">
      <div class="slider-item" style="background-image:url(./images/img1.jpg);">  </div>
      <div class="slider-item" style="background-image:url(./images/img2.jpg);">  </div>
      <div class="slider-item" style="background-image:url(./images/img3.jpg);">  </div>


    </section>

    <section class="ftco-services ftco-no-pb" id="section-vision">
          ...
          <div class="col-md-6 d-flex services align-self-stretch py-5 px-4 ftco-animate bg-darken">
            <div class="media block-6 d-block text-center">
              <div class="icon d-flex justify-content-center align-items-center">
                  <span><img src="images/img2.jpg" style="width: 75px"> </img></span>
              </div>
              <div class="media-body p-2 mt-3">
                <h3 class="heading">Our Vision</h3>
                <p> Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic.</p> <!--2020 දී වැඩිම පිරිසක් විල්ගමුවෙන් සරසවියට-->
              </div>
            </div>    
          </div>
          <div class="col-md-6 d-flex services align-self-stretch py-5 px-4 ftco-animate bg-primary">
            <div class="media block-6 d-block text-center">
              <div class="icon d-flex justify-content-center align-items-center">
                  <span><img src="images/staff-1.jpg" style="width: 75px"> </img></span>
              </div>
              <div class="media-body p-2 mt-3">
    	...
    	<div class="container">
          ...
          <div class="col-md-6 heading-section heading-section-white ftco-animate pl-lg-5 pt-md-0 pt-5">
            <h2 class="mb-4">Maraka Secondary School</h2>
    			...
    			<div class="col-lg-12">
		          ...
		          <div class="col-md d-flex justify-content-center counter-wrap ftco-animate">
		            <div class="block-18">
		            	<div class="icon"><span class="flaticon-doctor"></span></div>
		              <div class="text">
		                <strong class="number" data-number="740">0</strong>
		                <span>Students</span>
		              </div>
		            </div>
		          </div>
